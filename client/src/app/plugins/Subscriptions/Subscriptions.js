...
(function(module) {
    ...
    module.controller('MeSubscriptionController', function(SubscriptionsPlans, MeSubscriptions, UserSubscriptionsDetail, UpdateUserSubscriptions, $rootScope, $scope, $location, $state, $filter, TokenServiceData, flash, $interval) {
        var model = this;
...
(function(module) {
    ...
    module.controller('subscribePaymentController', function($scope, getGateways, $sce, Countries, subscribePayNow, ViewCourse, $state, $window, $location, GetSubscriptionDetail, SubscriptionsPlans, flash, $filter, TokenServiceData, $rootScope) {
        var model = this;
        model.loading = true;
        $scope.gatewayError = '';
...
(function(module) {
    ...
    module.controller('subscriptionsPlanController', function($state, SubscriptionsPlans, $scope, $modal) {
        var model = this;
...
(function(module) {
    module.factory('SubscriptionsPlans', function($resource, GENERAL_CONFIG) {
    ...
    module.factory('subscribePayNow', function($resource, GENERAL_CONFIG) {
        return $resource(
    ...
    module.factory('MeSubscriptions', function($resource, GENERAL_CONFIG) {
    ...
    module.factory('UserSubscriptionsDetail', function($resource, GENERAL_CONFIG) {
    ...
    module.factory('UpdateUserSubscriptions', function($resource, GENERAL_CONFIG) {
