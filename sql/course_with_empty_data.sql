...
UPDATE "settings" SET "value" = 'VideoLessons, SocialShare, SocialLogins, UserProfile, Instructor, Comments, Translations, SEO' WHERE name = 'site.enabled_plugins';

UPDATE "settings" SET "value" = 'Trainr' WHERE "name" = 'site.name';
